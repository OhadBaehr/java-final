...
public class PasswordInput extends JPanel{
    ...
    public PasswordInput(String placeholder, String description, String icon,Dimension preferedSizeTextField,Dimension preferedSizeLabel){
    ...
    public PasswordInput(String placeholder, String description, String icon,Dimension preferedSizeTextField) {
